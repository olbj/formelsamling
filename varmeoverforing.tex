...
\textbf{Dimensionslösa tal} 
	...
	\begin{align*}
		...
		\right]
	\end{align*}
	\subsubsection*{Turbulent internt flöde, rör (Dittus-Boelter)}
	\begin{align*}
	...
	\right]
	\end{align*}
	\subsubsection*{Turbulent internt flöde, rör (Gnielinski)}
	\begin{align*}
  ...
  {1 + 12.7\,\left(\dfrac{f}{8}\right)^{1/2}\left(Pr^{2/3} - 1\right)} \\[8pt]
	...
	\end{align*}
	\subsubsection*{Laminärt internt flöde, rör (Sieder och Tate)}
	\begin{flalign*}
