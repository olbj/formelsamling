...
\textbf{Dimensionslösa tal och defenitioner} 
	...
	& \beta = \dfrac{1}{T} \text{ (volymutvidgningskoefficienten) och} \\[8pt]
	& T = \dfrac{T_\infty +T_s}{2} \text{ (fluidens medeltemperatur)} \\
  ...
  {1 + 12.7\,\left(\dfrac{f}{8}\right)^{1/2}\left(Pr^{2/3} - 1\right)} \\[8pt]
	...
	\begin{align*}
		...
		&Nu = 0,1 \cdot Ra^{1/3} \text{ då } 10^13 \lesssim Ra \lesssim 10^{13}\\
