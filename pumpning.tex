...
\textbf{Uppfordringshöjd:} 
	...
	\end{align*}
där $p_{ut}-p_{in}$ = ökningen av det statiska trycket i pumpen, $p_{0,ut}-p_{0,in}$ = ökningen av totaltrycket (stagnationstrycket) i pumpen och $\Delta h_f$ = friktionsförluster i rörsystemet. \par
